...
var widgetMarkdownOverrides = [
  ...
  /* contact 气泡使用 github-markdown-css dark 主题，覆盖气泡适配属性 */
  "#unichat-widget .uw-msg.contact .markdown-body {",
  "  background: transparent; color: #fff;",
  "  font-size: 14px; font-family: inherit; line-height: 1.5;",
  "}",
  "#unichat-widget .uw-msg.contact .markdown-body p,",
  ...
  "#unichat-widget .uw-msg.contact .markdown-body li { color: #fff; }",
  "#unichat-widget .uw-msg.contact .markdown-body blockquote { color: rgba(255,255,255,0.7); }",
  "#unichat-widget .uw-msg.contact .markdown-body h1,",
  ...
  "#unichat-widget .uw-msg.contact .markdown-body td { border: 1px solid rgba(255,255,255,0.15); }",
